...
namespace test
{
    public partial class Data_preprocessing : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            textBox2.Text = System.IO.Path.GetFileName(inputpath);
        ...
        {
            //select_index = this.comboBox1.SelectedIndex;
            ...
            //    {
            //        Form1.elevation.Add(double.Parse(feature.get_Value(select_index).ToString()));
            //    }
