...
namespace test
{
    ...
    class GraphStruct
    {
        ...
        public int GetIndex(VexNode vexNode1)
        {
            for (int i = 0; i < this.VexNum; i++)
            {
                if (util.getDistanceOfTwoPoints(this._vexList[i].Data.PointL, vexNode1.Data.PointL) < 0.1)
                    return i;
            }
        ...
        //删除vex1中与vexId2的邻接边
        private bool DeleteEdge(ArgPoint vex1, int vexId2)
        {
