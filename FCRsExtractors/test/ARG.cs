...
namespace test
{
    public partial class ARG : Form
    {
        ...
        public string savepath_line;
        public string savepath_point;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Entity.ST = double.Parse(textBox3.Text);
            Entity.LT = double.Parse(textBox4.Text);
            savepath_line = textBox2.Text;
            savepath_point = textBox5.Text; 
            this.Dispose();
        }
